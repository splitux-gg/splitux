...
labels: handler
assignees: gabrielgad

---

**Controller support**
Does the game have native controller support? If not, is there a mod for the game that adds controller support? Specify that here. Do note that Splitux is a controller-only app for now, so any game that only supports keyboard and mouse for input will not work.
