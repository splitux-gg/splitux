...
pub fn launch_cmds(
    ...
    if (runtime == "scout" && !PATH_STEAM.join("ubuntu12_32/steam-runtime/run.sh").exists())
        || (runtime == "soldier"
            && !PATH_STEAM
    ...
    // Backends are presence-based: goldberg_settings, photon_settings, facepunch_settings
    ...
    for (i, instance) in instances.iter().enumerate() {
        ...
        if !h.disable_bwrap {
            ...
            if win {
                ...
                // This ensures Unity games save to the profile's sandboxed home
